        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <a href="#home" class="flex items-center gap-2.5">
                    <div class="flex items-center justify-center w-9 h-9 rounded-lg bg-gradient-to-br from-libra-amber-500 to-libra-coral-500">
                ...
                <div data-aos="fade-left" data-aos-delay="200" class="relative">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        <img
                            ...
                            alt="Djeca uče i crtaju zajedno u učionici"
    ...
    <section id="workshops" class="py-20 lg:py-28 bg-gradient-libra-section">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {{-- Card 1: Matematička pripremljenost --}}
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="0">
                    <div class="w-14 h-14 bg-libra-amber-100 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-libra-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25v-.008zm2.498-6.75h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007v-.008zm0 2.25h.007v.008h-.007v-.008zm2.504-6.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm2.498-6.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zM8.25 6h7.5v2.25h-7.5V6zM12 2.25c-1.892 0-3.758.11-5.593.322C5.307 2.7 4.5 3.65 4.5 4.757V19.5a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V4.757c0-1.108-.806-2.057-1.907-2.185A48.507 48.507 0 0012 2.25z" />
                        </svg>
                    </div>
                    <span class="inline-block px-3 py-1 bg-libra-amber-50 text-libra-amber-700 text-xs font-medium rounded-full mb-4">Dob 4-7</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Matematička pripremljenost</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Brojanje, uzorci, oblici i rane vještine rješavanja problema kroz igru i praktične aktivnosti.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-amber-600 hover:text-libra-amber-700 group transition-colors">
                        Saznaj više
                ...
                {{-- Card 2: Čitanje i pisanje --}}
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="100">
                    <div class="w-14 h-14 bg-libra-coral-100 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-libra-coral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                        </svg>
                    </div>
                    <span class="inline-block px-3 py-1 bg-libra-coral-50 text-libra-coral-600 text-xs font-medium rounded-full mb-4">Dob 4-7</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Čitanje i pisanje</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Prepoznavanje slova, fonika, pripovijedanje i fine motoričke vještine za izgradnju čvrstih temelja pismenosti.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-coral-500 hover:text-libra-coral-600 group transition-colors">
                        Saznaj više
                        <svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                ...
                {{-- Card 3: Istraživanje znanosti --}}
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-14 h-14 bg-libra-purple-100 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-libra-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 5.61c.137.546-.272 1.09-.838 1.09H3.636c-.566 0-.975-.544-.838-1.09L4.2 15.3" />
                        </svg>
                    </div>
                    <span class="inline-block px-3 py-1 bg-libra-purple-50 text-libra-purple-600 text-xs font-medium rounded-full mb-4">Dob 5-8</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Istraživanje znanosti</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Jednostavni eksperimenti, promatranje prirode i STEM koncepti koji bude znatiželju o svijetu oko nas.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-purple-500 hover:text-libra-purple-600 group transition-colors">
                        Saznaj više
                        <svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                ...
                {{-- Card 4: Kreativne umjetnosti --}}
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="0">
                    <div class="w-14 h-14 bg-libra-red-50 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-libra-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" />
                        </svg>
                    </div>
                    <span class="inline-block px-3 py-1 bg-libra-red-50 text-libra-red-600 text-xs font-medium rounded-full mb-4">Dob 3-6</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Kreativne umjetnosti</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Crtanje, slikanje, glazba i kreativno izražavanje koje razvija maštu i fine motoričke vještine.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-red-500 hover:text-libra-red-600 group transition-colors">
                        Saznaj više
                        <svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                ...
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <span class="inline-block px-3 py-1 bg-libra-amber-50 text-libra-amber-700 text-xs font-medium rounded-full mb-4">Dob 3-7</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Socijalne vještine</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Timski rad, dijeljenje, komunikacija i emocionalna inteligencija kroz grupne aktivnosti i vođenu igru.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-amber-600 hover:text-libra-amber-700 group transition-colors">
                        Saznaj više
                        <svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="workshop-card bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <span class="inline-block px-3 py-1 bg-libra-coral-50 text-libra-coral-600 text-xs font-medium rounded-full mb-4">Dob 5-7</span>
                    <h3 class="text-xl font-bold text-libra-warm-text mb-3">Priprema za školu</h3>
                    <p class="text-libra-warm-text-secondary leading-relaxed mb-6">
                        Sveobuhvatni program spremnosti koji kombinira sve ključne vještine: rutine, samostalnost, koncentraciju i akademske temelje.
                    </p>
                    <a href="#contact" class="inline-flex items-center text-sm font-semibold text-libra-coral-500 hover:text-libra-coral-600 group transition-colors">
                        Saznaj više
                        <svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
